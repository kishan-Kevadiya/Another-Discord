...
const LandingPage = ({ children }: LandingPageProps) => {
    ...
    return (
        <>
            ...
            <div className="relative bg-gradient-to-b from-white to-blue-300 min-h-screen overflow-hidden">
                    ...
                    <div className="max-w-2xl px-6 py-32 sm:py-48 lg:py-56 text-center">
                        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                                Announcing our co-partner of{' '}
                                <span className="border-b border-green-500">Discord Server</span>.{' '}
            ...
            <footer className="relative bg-gray-800 overflow-hidden">
                ...
                <div className="relative z-10 flex justify-center items-center h-full text-white">
                    <div className="max-w-7xl px-4 sm:px-6 lg:px-8 py-20 text-center">
                        ...
                        <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-6 rounded-lg transition duration-300 ease-in-out mb-6">
                            Contact Us
                        </button>
                        <p className="text-lg text-gray-300 mb-4">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum non efficitur justo, et
                            cursus nisi. Donec euismod libero eget ligula pulvinar ullamcorper.
                        </p>
                        <p className="text-sm text-gray-400">
                            Developed by <span className="text-highlight">Kishan Kevadiya & Krupal Solanki</span>
                        </p>
                    </div>
                </div>
            </footer>
